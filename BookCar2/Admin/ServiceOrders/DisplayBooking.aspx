<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="DisplayBooking.aspx.cs" Inherits="BookCar2.Admin.ServiceOrders.DisplayBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style4">
                <strong>
                <asp:Label ID="Label13" runat="server" Text="Booking" ForeColor="Red"></asp:Label>
                </strong></td>
            <td class="auto-style6">&nbsp;</td>
            <td class="auto-style7">
                &nbsp;</td>
