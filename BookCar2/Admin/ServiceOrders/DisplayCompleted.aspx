<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="DisplayCompleted.aspx.cs" Inherits="BookCar2.Admin.ServiceOrders.DisplayCompleted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtDes" CssClass="textBox" runat="server" Width="170px" Height="69px" TextMode="MultiLine" BackColor="#99CCFF" ReadOnly="True"></asp:TextBox>
            </td>
            <td class="auto-style6">&nbsp;</td>
            <td class="auto-style7">&nbsp;</td>
            <td>&nbsp;</td>
